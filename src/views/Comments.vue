<template>
  <div>
    <div v-clickOutSide="hideReplyBtn" @click="inputFocus" class="my-reply">
      <van-image class="header-img" width="60" height="60" round :src="myHeader"></van-image>
      ...
      <div class="reply-btn-box" v-show="btnShow">
        <van-button class="reply-btn" size="mini" @click="sendComment" type="primary">发表评论</van-button>
      </div>
    </div>
    <div v-for="(item,i) in comments" :key="i" class="author-title reply-father">
      <van-image class="header-img" width="60" height="60" round :src="item.headImg"></van-image>
      ...
      <div class="icon-btn">
        <span @click="showReplyInput(i,item.name,item.id)">
          <van-icon name="chat-o"/>{{ item.commentNum }}
        </span>
      ...
      <div class="reply-box">
        <div v-for="(reply,j) in item.reply" :key="j" class="author-title">
          <van-image class="header-img" width="60" height="60" round :src="reply.fromHeadImg"></van-image>
          <div class="author-info">
            <span class="author-name">{{ reply.from }}</span>
            <span class="author-time">{{ reply.time }}</span>
          </div>
          <div class="icon-btn">
            <span style="cursor: pointer;" @click="showReplyInput(i,reply.from,reply.id)">
          ...
          <div class="talk-box">
            <p>
              <span style="color: #ccc">回复 {{ reply.to }}:</span>
      ...
      <div v-show="_inputShow(i)" class="my-reply my-comment-reply">
        ...
        <div class=" reply-btn-box">
          <van-button class="reply-btn" size="mini" @click="sendCommentReply(i,j)" type="primary">发表评论</van-button>
        </div>
      </div>
    </div>
  </div>
...
<script>
import {Button, Icon, Notify} from 'vant';
  ...
  methods: {
    ...
    sendComment() {
      if (!this.replyComment) {
        Notify({type: 'success', message: '评论不能为空'});
      } else {
        let a = {}
